        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <li><a href="/trends/new-york/restaurants" style={{ color: '#4f46e5', textDecoration: 'none' }}>Fastest Growing Restaurants in New York</a></li>
              <li><a href="/trends/los-angeles/gyms" style={{ color: '#4f46e5', textDecoration: 'none' }}>Trending Gyms in Los Angeles</a></li>
              <li><a href="/trends/chicago/salons" style={{ color: '#4f46e5', textDecoration: 'none' }}>Viral Salons in Chicago</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              <li><a href="/directory/los-angeles/restaurants" style={{ color: '#4f46e5', textDecoration: 'none' }}>Best Restaurants in Los Angeles</a></li>
              <li><a href="/directory/chicago/gyms" style={{ color: '#4f46e5', textDecoration: 'none' }}>Top Ranked Gyms in Chicago</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <li><a href="/leads/new-york/gyms" style={{ color: '#4f46e5', textDecoration: 'none' }}>New York Gyms Missing Websites</a></li>
              <li><a href="/leads/los-angeles/salons" style={{ color: '#4f46e5', textDecoration: 'none' }}>Los Angeles Salons Without Websites</a></li>
